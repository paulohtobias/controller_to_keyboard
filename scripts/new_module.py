...
project_settings = {
	"PROJECT_NAME": "Controller to Keyboard",
	"PREFFIX": "",
}

for key in project_settings:
	globals()[key] = project_settings[key]
	if len(project_settings[key]) == 0:
...
if __name__ == "__main__":
	...
	if args.header == None:
		with open("include/" + name.header, "wb") as f:
			...
			files.writeln("#endif " + Comment_Classic.create_comment(name.guard, 0))
